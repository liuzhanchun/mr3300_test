...
CUdpServer *g_pData = NULL; //定义全局指针;
CUdpServer *g_pAud = NULL; //定义全局指针;
//CUdpServer *g_pResp = NULL;
CUdpServer *g_pIF = NULL;
...
int CUdpServer::ReceiveData(char * pBuffer, UINT & nRecv, UINT RecvSize = 0)
{
	...
	tv.tv_sec = 0;
	tv.tv_usec = 50;
	select(m_ReceivingSocket + 1, &readfds, NULL, NULL, &tv);
